...
const AboutMe = () => {
  return (
    <div className='m-12 py-14 flex  md:flex-col justify-evenly ' >
       <div className="bg-white font-bold text-3xl p-4 rounded-3xl h-fit my-auto md:mx-auto w-fit">About Me</div>
