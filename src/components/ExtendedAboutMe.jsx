  ...
  return (
   <div  className='pt-10 p-5 mr-24 lg:mr-10 md:mr-5 sm:mr-0 '>
    ...
    <div className='text-2xl md:text-xl w-[60%] md:w-full'>
     ...
     <div><a href="https://drive.google.com/file/d/1cYTjQjpRlKZBnMfOzAz2Ca-japNvn_c6/view?usp=sharing" className='text-blue-700 underline hover:bg-yellow-200 p-2 rounded-2xl'>My Resume</a></div>
     </div>
     ...
     <div className='text-2xl md:text-xl flex md:flex-col md:space-y-6 justify-between w-[70%] md:w-full lg:w-[85%] items-center pt-6 '><div className=' md:mx-auto border-b-4 border-yellow-200'>Web-development</div> <div className=' md:mx-auto border-b-4 border-yellow-200'>System Design</div>
     <div className=' md:mx-auto border-b-4 border-yellow-200'>Content Writing</div>
       </div>
     </div>
