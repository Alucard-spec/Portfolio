  ...
  return (
   <div  className='pt-10 p-5 mr-24 lg:mr-10 md:mr-5 sm:mr-0 '>
    ...
    <div className='text-2xl md:text-xl w-[60%] md:w-full'>
     ...
     <div><a href="https://drive.google.com/file/d/1zgZD_OLylEWCBuM3nQeZVpTArGLLHlpo/view?usp=sharing" className='text-blue-700 underline hover:bg-yellow-200 p-2 rounded-2xl'>My Resume</a></div>
     </div>
