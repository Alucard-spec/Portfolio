...
<a href="https://spotify-clone-oydb.vercel.app/" className='text-blue-800 font-bold hover:bg-white p-1 rounded-xl'>Github Repo</a> </div>
...
<img className=' object-cover mx-auto ' alt='project sample' src={require("./Content Writing/Spotify_clone.png")}  /></div>
    ...
    <div className=' py-14 bg-white  flex  flex-col justify-evenly border-2 border-black ' >
      ...
      <br />
        ...
        <a href="https://github.com/Alucard-spec/RPL-Todo" className='text-blue-800 font-bold hover:bg-white p-1 rounded-xl'>Github Repo</a>  </div>
<br /><div className='w-[40%] md:w-full'>
<img className='object-cover mx-auto ' alt='Project sample' src={require("./Content Writing/RPL.png")}  /></div>
    ...
    <div className=' py-14 bg-black text-white  flex  flex-col justify-evenly border-2 border-black ' >
      ...
      <br />
        ...
        <a href="https://github.com/Alucard-spec/platformer" className='text-blue-800 font-bold hover:bg-white p-1 rounded-xl'>Github Repo</a>  </div>
<br /><div className='w-[40%] md:w-full'>
<img className='object-cover mx-auto ' alt='Project sample' src={require("./Content Writing/Platformer.png")}  /></div>
    ...
    <div className=' py-14 bg-white  flex  flex-col justify-evenly border-2 border-black ' >
      ...
      <br />
        ...
        <a href="https://github.com/Alucard-spec/Type-Warrior" className='text-blue-800 font-bold hover:bg-white p-1 rounded-xl'>Github Repo</a>  </div>
<br /><div className='w-[40%] md:w-full'>
